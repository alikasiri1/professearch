  ...
  <header >
      <nav class="navbar navbar-expand-lg navbar-dark " style="background-color: #007acc;position: fixed;top: 0px;width: 100%;z-index: 1000;">
        <div class="container-fluid">
          <a class="navbar-brand" style="color:white;text-decoration: none;" href="{real_url}" target = "_self">
          ...
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
              <a class="nav-link active" aria-current="page" href="{real_url}loginpage" style="text-decoration: none;">login</a>
              <a class="nav-link disabled" href="{real_url}pricing?unknown?" >Pricing</a>
        ...
        <div class="container">
            <div class="panel pricing-table">
                <div class="pricing-plan">
                  ...
                  <a href="#"class= "pricing-button"  target = "_self" >Free trial</a>
                </div>
                <div class="pricing-plan">
                    <img src="https://s28.postimg.cc/ju5bnc3x9/plane.png" alt="" class="pricing-img">
                    <h2 class="pricing-header">Small team</h2>
                    <ul class="pricing-features" style="list-style: none;">
                    <li class="pricing-features-item" style="margin-left: 0px;padding-left: 0px;margin-bottom: 3px;">Never sleeps</li>
                    <li class="pricing-features-item" style="margin-left: 0px;padding-left: 0px;margin-bottom: 3px;">Multiple workers for more powerful apps</li>
                    </ul>
                    <span class="pricing-price">50000t</span>
                    <a href="{real_url}pricing?500000?{user}" class="pricing-button is-featured"  target = "_self">BUY</a>
                </div>
                <br>
                <div class="pricing-plan">
                    ...
                    <ul class="pricing-features" style="list-style: none;">
                    <li class="pricing-features-item" style="margin-left: 0px;padding-left: 0px;margin-bottom: 3px;">Dedicated </li>
                    <li class="pricing-features-item" style="margin-left: 0px;padding-left: 0px;margin-bottom: 3px;">Simple horizontal scalability</li>
                    </ul>
                    <span class="pricing-price">80000t</span>
                    <a href="{real_url}pricing?800000?{user}" class="pricing-button"  target = "_self">BUY</a>
                </div>
            </div>
        </div>
    </div>
